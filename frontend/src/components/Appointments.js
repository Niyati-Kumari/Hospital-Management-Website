...
const Appointments = () => {
    ...
    useEffect(() => {
        axios
            .get('https://hospital-management-app-wna4.onrender.com/appointments')
    ...
    const handleAddAppointment = (e) => {
        ...
        axios
            .post('https://hospital-management-app-wna4.onrender.com/appointments/add', newAppointment)
            .then((response) => {
    ...
    const handleUpdateAppointment = (id, e) => {
        e.preventDefault();
        axios
            .post(`https://hospital-management-app-wna4.onrender.com/appointments/update/${id}`, selectedAppointment)
            .then((response) => {
    ...
    const handleDeleteAppointment = (id) => {
        axios
            .delete(`https://hospital-management-app-wna4.onrender.com/appointments/delete/${id}`)
            .then(() => {
